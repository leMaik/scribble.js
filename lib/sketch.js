...
sketchjs = function($) {
  ...
  Sketch = (function() {
    function Sketch(el, opts) {
      var bgImage, currentTool, getCursorPosition;
      this.el = el;
      this.canvas = $(el);
      this.options = $.extend({
        toolLinks: true,
      ...
      currentTool = (function(_this) {
        return function() {
          return $.sketch.tools[$(_this).data('sketch').tool];
        };
      })(this);
      this.canvas.bind('mousedown touchstart', function(e) {
        ...
        this.actions = currentTool().startUse.call(void 0, this.context, getCursorPosition(), this.actions);
        return this.redraw();
      });
      this.canvas.bind('mousemove touchmove', function(e) {
        this.actions = currentTool().continueUse.call(void 0, this.context, getCursorPosition(), this.actions);
        return this.redraw();
      });
      this.canvas.bind('mouseup mouseleave mouseout touchend touchcancel', function(e) {
        this.actions = currentTool().stopUse.call(void 0, this.context, getCursorPosition(), this.actions);
        return this.redraw();
      });
    ...
    Sketch.prototype.redraw = function() {
      ...
      if (this.painting && this.action) {
        return $.sketch.tools[this.action.tool].draw.call(void 0, this.action, context);
      }
    };
