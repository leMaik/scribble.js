...
sketchjs = function($) {
    ...
    function Sketch(el, opts) {
      ...
      this.canvas.bind('mousedown touchstart', (function(_this) {
        return function(e) {
          ...
          _this.actions = currentTool().startUse.call(void 0, _this.canvas[0].getContext('2d'), getCursorPosition(e), _this.actions, _this.redraw.bind(_this));
          return _this.redraw();
        };
      })(this));
  ...
  $.sketch.tools.text = {
    ...
    startUse: function(context, position, actions, redraw) {
      var event;
      ...
      $('body').on('keypress.sketchjstexttool', function(e) {
        ...
        if (e.keyCode === 13) {
          if (e.shiftKey) {
            ...
            return $('body').off('.sketchjstexttool');
          }
        } else {
