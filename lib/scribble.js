...
scribblejs = function($) {
  ...
  Scribble = (function() {
    function Scribble(el, opts) {
      ...
      this.canvas.bind('mousedown touchstart', (function(_this) {
        return function(e) {
          painting = true;
          old = _this.getShapes();
          _this._undo.push(_this.getShapes());
          _this.actions.push({
            tool: _this.tool,
            color: _this.color,
    ...
    Scribble.prototype.undo = function() {
      this.actions = this._undo.undo(this.getShapes());
      return this.redraw();
    };

    Scribble.prototype.redo = function() {
      this.actions = this._undo.redo(this.getShapes());
      return this.redraw();
    };
...
},{"./undo":3}],3:[function(require,module,exports){
...
Undo = (function(superClass) {
  ...
  Undo.prototype.push = function(state) {
  ...
  Undo.prototype.undo = function(state) {
    var restoredState;
    if (this.undoStack.length > 0) {
      this.redoStack.push(state);
      restoredState = this.undoStack.pop();
      if (this.undoStack.length === 0) {
        this.trigger('undoUnavailable');
      }
      if (this.redoStack.length === 1) {
        this.trigger('redoAvailable');
      }
  ...
  Undo.prototype.redo = function(state) {
    var restoredState;
    if (this.redoStack.length > 0) {
      this.undoStack.push(state);
      restoredState = this.redoStack.pop();
      if (this.undoStack.length === 1) {
        this.trigger('undoAvailable');
      }
      if (this.redoStack.length === 0) {
        this.trigger('redoUnavailable');
      }
      return restoredState;
    }
    return state;
