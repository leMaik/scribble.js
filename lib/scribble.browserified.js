...
var Undo,scribblejs,slice=[].slice;Undo=require("./undo"),scribblejs=function(t){var n;return t.fn.scribble=function(){var o,e,i;return e=arguments[0],o=2<=arguments.length?slice.call(arguments,1):[],this.length>1&&t.error("Scribble.js can only be called on one element at a time."),i=this.data("scribble"),"string"==typeof e&&i?i[e]?"function"==typeof i[e]?i[e].apply(i,o):0===o.length?i[e]:1===o.length?i[e]=o[0]:void 0:t.error("Scribble.js did not recognize the given command."):i?i:(this.data("scribble",new n(this.get(0),e)),this)},n=function(){function n(n,o){var e,i,r,a,s,c;this.el=n,this.canvas=t(n),this.options=t.extend({toolLinks:!0,defaultTool:"marker",defaultColor:"#000000",defaultSize:5,undo:new Undo},o),this.scale=1,this.color=this.options.defaultColor,this.size=this.options.defaultSize,this.tool=this.options.defaultTool,this.background=void 0,null!=this.canvas.data("background")&&(e=new Image,e.onload=function(t){return function(){return t.background=e,t.redraw()}}(this),e.src=this.canvas.data("background")),this.actions=[],this._undo=this.options.undo,this._undo.on("undoAvailable",function(t){return function(){return t.canvas.trigger("scribble:undoAvailable")}}(this)),this._undo.on("undoUnavailable",function(t){return function(){return t.canvas.trigger("scribble:undoUnavailable")}}(this)),this._undo.on("redoAvailable",function(t){return function(){return t.canvas.trigger("scribble:redoAvailable")}}(this)),this._undo.on("redoUnavailable",function(t){return function(){return t.canvas.trigger("scribble:redoUnavailable")}}(this)),r=function(t){return function(n){return null==n?{x:0,y:0}:(n.originalEvent&&n.originalEvent.targetTouches&&(n.pageX=n.originalEvent.targetTouches[0].pageX,n.pageY=n.originalEvent.targetTouches[0].pageY),{x:(n.pageX-t.canvas.offset().left)/t.scale,y:(n.pageY-t.canvas.offset().top)/t.scale})}}(this),i=function(n){return function(){return t.scribble.tools[n.tool]}}(this),a=[],s=!1,c=function(n){return function(o,e,c){var u;return c=c?t.scribble.tools[c]:i(),c&&(s||c.customStopHandling)?(s=!1,n.actions=c.stopUse.call(void 0,n.canvas[0].getContext("2d"),r(o),n.actions,n.scale),n.redraw(),u=function(t,o){return{undo:function(){return n.actions=t,n.redraw()},redo:function(){return n.actions=o,n.redraw()}}},n._undo.push(u(a.slice(0),n.actions.slice(0))),n.canvas.trigger("afterPaint",[n.actions,a])):void 0}}(this),this.canvas.on("scribble:toolchanged",c),this.canvas.bind("mousedown touchstart",function(t){return function(n){return i().usesMouse&&i().usesMouse()?void 0:(s&&c(n),s=!0,a=t.getShapes(),t.actions.push({tool:t.tool,color:t.color,size:parseFloat(t.size),events:[]}),t.actions=i().startUse.call(void 0,t.canvas[0].getContext("2d"),r(n),t.actions,t.redraw.bind(t),c,t.scale),t.redraw())}}(this)),this.canvas.bind("mousemove touchmove",function(t){return function(n){return i().usesMouse&&i().usesMouse()||!s?void 0:(t.actions=i().continueUse.call(void 0,t.canvas[0].getContext("2d"),r(n),t.actions,t.scale),t.redraw())}}(this)),this.canvas.bind("mouseup mouseleave mouseout touchend touchcancel",function(t){return function(t){return i().usesMouse&&i().usesMouse()||i().customStopHandling&&i().customStopHandling()?void 0:c(t)}}(this)),this.options.toolLinks&&t("body").delegate('a[href="#'+this.canvas.attr("id")+'"]',"click",function(n){var o,e,i,r,a,s,c;for(e=t(this),o=t(e.attr("href")),c=o.data("scribble"),s=["color","size","tool"],i=0,a=s.length;a>i;i++)r=s[i],e.attr("data-"+r)&&c.set.call(c,r,t(this).attr("data-"+r));if(t(this).attr("data-download")&&c.download.call(c,t(this).attr("data-download")),t(this).attr("data-action"))switch(e.attr("data-action")){case"undo":c.undo.call(c);break;case"redo":c.redo.call(c)}return!1})}return n.prototype.download=function(t){var n;return t||(t="png"),"jpg"===t&&(t="jpeg"),n="image/"+t,window.open(this.el.toDataURL(n))},n.prototype.setScale=function(t){return this.scale=t,this.redraw()},n.prototype.getShapes=function(){return this.actions.slice()},n.prototype.loadShapes=function(t,n){var o;return null==n&&(n=!1),o=this.actions,this.actions=t,this.redraw(),n?void 0:this.canvas.trigger("afterPaint",[this.actions,o])},n.prototype.undo=function(){return this._undo.undo()},n.prototype.redo=function(){return this._undo.redo()},n.prototype.set=function(t,n){var o;return o=this[t],this[t]=n,"tool"===t&&this.canvas.trigger("scribble:toolchanged",[n,o]),this.canvas.trigger("sketch.change"+t,[n,o])},n.prototype.redraw=function(t){var n;return this.el.width=this.canvas.width(),n=this.el.getContext("2d"),this.drawOn(n,this.canvas.width(),this.canvas.height(),t)},n.prototype.drawOn=function(t,o,e,i){var r,a,s,c;return null!=this.background&&(c=this.background.width/this.background.height,s=c*e,a=e,s>o&&(s=o,a=s/c),t.drawImage(this.background,0,0,this.background.width,this.background.height,0,0,s,a)),r=null!=i?this.actions.filter(i):this.actions,n.drawShapesOn(contect,r,this.scale)},n.drawShapesOn=function(n,o,e){var i,r,a;for(r=0,a=o.length;a>r;r++)i=o[r],i.tool&&t.scribble.tools[i.tool].draw.call(void 0,i,n,e||1)},n}(),t.scribble={tools:{marker:require("./tools/marker"),highlighter:require("./tools/highlighter"),eraser:require("./tools/eraser"),text:require("./tools/text")}},n},scribblejs.Undo=Undo,module.exports=scribblejs;
